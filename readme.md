...
## The Technology, Programs and Deployment
 ...
 This website was created using HTML & CSS through the VS Code Program. Source Code was uploaded to GitHub. Deployment was done through netlify using GitHub as the source. Vireframe was done using Figma. Site map was made using draw.io.
...
The Navigation bar made it very easy to navigate the website as the links were neat, simple bestowing a clean and artful website. Using their website as inpiration I was able to create my own design. Footer is very clean and bold highlighting important links.
...
There were three main colours that I used for this website to brighten the website and engage and guide the audience to the navigation and important links. Green seemed to be a very relaxing colour signifying growth and pleasing to the eyes.
...
The colours were also used to provide website accessibilty. Colour 1 is used to guide the viewer to the most important links by being quite bold in comparison to the background.
...
Colour 3 was used to give you an indiction of where you are in regards to which page you are currently viewing for either Home, About, Blog. Image below shows you are on the about page.
...
The Logo I used was an AI Generated Image rendering of myself. The goal of this website is to convey my professional skillset, character, and experience. Therefore, it is pertinent to create a logo that respresented myself as well as incorporate modern technology references like AI, similarly to how I used .io in the domain. The logo itself is a link to the home page to further allow for ease of navigation.
...
The Technology Stack section can either be accessed a link into the section or by scrolling down. This section is repeated in relevant areas of the site such as index, about, and the contact page as it is a clear indication on the kind of work I am capable of and the particular skills that employers are looking for. However, it is removed from the blog section as it may detract from the content. 
...
The footer is consistent through out the website and has links to all the socials and to navigate back to home page via the logo.
...
Each individual blog can be accessed and viewed by hovering over the blog button. The image becomes darker and blurred, allowing white text to appear and illustrate the entire blog. On the mobile website these images act as buttons and the same blog will be responsive to the mobile or tablet viewports.
